...
import { JobresDetail } from '../jobres/Jobresdetail';
import { JobresPage } from '../jobres/JobresPage';
import { JobresPageNew } from '../jobres/JobresPageNew';
...
const AuthRouters: Array<RouterType> = [
  ...
  {
    path: '/jobresdetail/:id',
    children: <JobresDetail />,
  },
  {
    path: '/jobres/new',
    children: <JobresPageNew />,
  },
  {
    path: '/homedetail/:id',
